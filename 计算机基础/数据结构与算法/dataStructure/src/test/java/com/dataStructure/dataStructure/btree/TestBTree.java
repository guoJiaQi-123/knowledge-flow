...
import com.dataStructure.dataStructure.btree.BTree;
...
class TestBTree {
    ...
    void split2() {
        ...
        root.keys[0] = 6;
        root.keyNumber = 1;
        root.childrens[0] = new BTree.Node(new int[]{1, 2, 3, 4, 5});
        root.childrens[0].keyNumber = 5;

        root.childrens[1] = new BTree.Node(new int[]{7});
        root.childrens[1].keyNumber = 1;

        tree.split(root.childrens[0], root, 0);
        assertEquals("[3, 6]", root.toString());
        assertEquals("[1, 2]", root.childrens[0].toString());
        assertEquals("[4, 5]", root.childrens[1].toString());
        assertEquals("[7]", root.childrens[2].toString());
    }
    ...
    void testPut1() {
        ...
        */
        ...
        assertEquals("[10]", tree.root.childrens[2].toString());
        ...
        assertEquals("[9]", tree.root.childrens[2].childrens[0].toString());
        assertEquals("[11]", tree.root.childrens[2].childrens[1].toString());
    ...
    void testSearch() {
        ...
        assertEquals(tree.root.childrens[0], tree.root.get(2));
        assertEquals(tree.root.childrens[0].childrens[0], tree.root.get(1));
        assertEquals(tree.root.childrens[0].childrens[1], tree.root.get(3));
        assertEquals(tree.root.childrens[1], tree.root.get(6));
        assertEquals(tree.root.childrens[1], tree.root.get(8));
        assertEquals(tree.root.childrens[1].childrens[0], tree.root.get(5));
        assertEquals(tree.root.childrens[1].childrens[1], tree.root.get(7));
        assertEquals(tree.root.childrens[1].childrens[2], tree.root.get(9));
        assertEquals(tree.root.childrens[1].childrens[2], tree.root.get(10));
